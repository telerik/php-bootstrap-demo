<?php
    ...
    $seriesItem2011->data(array(
        ...
        array('category' => 'Manchester', 'value' => 45),
        array('category' => 'Rochester', 'value' => 25)
    ));
    ...
    $seriesItem2012->data(array(
        array('category' => 'Canterbury', 'value' => 64),
        array('category' => 'Manchester', 'value' => 12),
        array('category' => 'Rochester', 'value' => 24)
    ));
    ...
    $title->text('Alice Mutton');
    $title->position('bottom');
    $title->padding(4);
    $title->margin(0);

    $chart = new \Kendo\Dataviz\UI\Chart("market-alice-mutton");
    $chart->title($title);
